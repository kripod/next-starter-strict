...
>(
	...
	return (
		<Element
			...
			className={clsx(
				"inline-flex items-center justify-center text-center font-medium leading-tight border focus:outline-none transition-colors motion-reduce:transition-none dark:ring-offset-black ring-offset-1 ring-opacity-60 dark:ring-opacity-60 focus-visible:ring",
				{
					[clsx(
						"text-sm",
						shape === "circle"
							? "h-9 w-9"
							: ["h-8", shape === "square" ? "w-8" : "px-2.5"],
					)]: size === "sm",
					[clsx(
						shape === "circle"
							? "h-12 w-12"
