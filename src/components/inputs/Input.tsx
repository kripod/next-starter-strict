...
export function Input({
	...
	return (
		<span className={clsx("inline-grid", className)} style={style}>
			<input
				className={clsx(
					"col-start-1 row-start-1 placeholder-gray-600/80 dark:placeholder-gray-400/80 bg-transparent rounded-md focus:ring ring-offset-1 dark:ring-offset-black transition-shadow motion-reduce:transition-none appearance-none focus:outline-none peer ring-blue-500/50 dark:ring-blue-400/50 invalid:ring-red-500/50 dark:invalid:ring-red-400/50",
					{
